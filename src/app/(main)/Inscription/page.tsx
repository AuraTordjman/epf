    ...
    <div className="max-w-md mx-auto mt-8 p-6 bg-gray-100 rounded-lg shadow-md">
      ...
      <form onSubmit={(event) => { event.preventDefault(); register(); }}>
        ...
        <div className="mb-4">
          ...
          <input type="email" id="email" className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500" required  pattern=".*@epfedu\.fr$"
  title="L'adresse email doit se terminer par @epfedu.fr" onChange={(e) => setRegisterEmail(e.target.value)} />
        </div>
        <label htmlFor="email" className="block text-gray-700 font-medium mb-1">Mot de passe :</label>
